export const surpriseMePrompts = [
    ...
    'An alien planet with strange, colorful flora and fauna',
    'A magical forest with talking animals and hidden secrets',
    'A post-apocalyptic wasteland with ruins of skyscrapers and decaying vehicles',
    'A deep-sea world with bioluminescent creatures and underwater caves',
    'A surreal dreamscape with floating islands and giant mushrooms',
    'A cybernetic city with robotic inhabitants and holographic advertisements',
    'A fantastical castle with towering turrets and a moat filled with mythical beasts',
    'A celestial landscape with planets, stars, and a bright, glowing nebula',
    'A mysterious temple with ancient artifacts and mystical energy',
    'A pastel-colored garden with oversized flowers and whimsical creatures',
    'A floating island made of clouds and filled with rainbows and unicorns',
    'A cozy bedroom with a canopy bed and soft, fluffy blankets',
    'A tea party in a meadow with rabbits and birds wearing human clothes',
    'A magical library with books that come to life and tell their own stories',
    'A starry night sky with a giant moon and shooting stars that leave glittery trails',
